/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/user/WatchWebHandler.java,v 1.76.2.1 2008/11/17 07:56:16 nguyendnc Exp $
 * $Author: nguyendnc $
 * $Revision: 1.76.2.1 $
...
public class WatchWebHandler {
    ...
    private static final Log log = LogFactory.getLog(WatchWebHandler.class);
    ...
    public void prepareAdd(GenericRequest request, GenericResponse response)
        ...
        CategoryTreeListener listener = categoryService.getManagementCategorySelector(request, response, true, "category");
